...
var accountSet = wire.NewSet(gateway.NewAccountGateway, database.NewPostgresAdapter, wire.Bind(new(database.DatabaseConnection), new(*database.PostgresAdapter)))
