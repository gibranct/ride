...
var accountCtrl = controller.NewRideController(application.NewApplication().RideService)

func Test_SignUpDriverAPI(t *testing.T) {
	type SignUpOutput struct {
		AccountId string `json:"accountId"`
	}
	account := gateway.SignUpInput{
		Name:        "John Doe",
	...
	var newAccount gateway.Account
...
func Test_SignUpPassengerWithInvalidEmailAPI(t *testing.T) {
	...
	signUpJson := gateway.SignUpInput{
		Name:        "John Doe",
